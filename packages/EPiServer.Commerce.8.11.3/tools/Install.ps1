...
if ($epiConnection -eq $null)
{
	...
	$commerceCoreDbPath = join-path  ($commerceCoreToolsPath) "EPiServer.Commerce.sql"

	#Update search config
	$searchConfigPath = Join-Path $toolsPath "Configs\Mediachase.Search.Config"
	$searchIndexBasePath = Join-Path $sitePath "\App_Data\Search\ECApplication\"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUEpuZliw9r5QWJFptu4gCXjqT
# 85igghP/MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRbBgwtuqrPGEE2p20PYsbfYOs0
# djANBgkqhkiG9w0BAQEFAASCAQAfmJan/mYp56l6r6+IZKbhmJhfmfVDT9e+r0l9
# jg348g7Bn3s/8a4XfB8ltIhswx3xcoXRD5dyaCKa4IpwEgmoJqQe1RyAxt0eZwjF
# 2MgiHYr2Wrjk9Qb3Be3tlkrO+Ocm/fteRymFMaCHsOUae5WFWlOlkMB98HRQpXIO
# hCOuuUV4/wPkqmks/5ctQTAgq+6nZJWxcP0LS6Xm8+j3ViHBwfUvb/BkK6XUWHLJ
# PIsqHrBF5ZqVVag39qvBzHWoHuZbBZQrH4uVmpwAIrrSnR8DCqz9MbDecdJ+RsO0
# ViK5z2njIf63ErmNPvNO8QGaD0eaj1W1z5BN/FVn7XiDN48ToYICCzCCAgcGCSqG
...
# MDQxNzA4MzgxNVowIwYJKoZIhvcNAQkEMRYEFCB+bfBErx4+POJnqnKbQLsrgXIW
# MA0GCSqGSIb3DQEBAQUABIIBAJSuhLY+L+JDbGq9u9FIxuzSL/jfjsD/+HAnRzcj
# cnPcSeA0AlUiMVmIK+sDlhV6b7LoEnGdaEdHJUpvOSOB/439tslxZLNEzIR+wuCP
# LAQ5mpFZ3b8tHN40lPBQTOIZVi5d5BCRjNHAhXzm+jPtF9Y5ojpaEIvSbXaAdsMP
# 1+4qGJTzihHdU/mql793ePHzBpp0gVIhV6V3DdyzzRxO6kv1eJHJEG46AtqLRpwr
# 8/tuB2cS/Cq01gj0kkaOyhUidqKQGrVT8gAqb2jru3v8CtQ9gsyzlw1GJXCAu89i
# hdmes0W80josC12hafK/sBSAqSar65Qv++dW06l8hR/jImk=
